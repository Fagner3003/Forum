...
var mesInformado = parseInt(prompt(nome + " qual o mês do seu nascimento? "));

var diaDeNascimento = parseInt(prompt(nome + " qual o dia do seu nascimento? "));

var mesJaneiro = ("Capricórnio");
var mesFevereiro = ("Aquário");
var mesMarco = ("Peixes");
var mesAbril = ("Áries");
var mesMaio = ("Touro");
var mesJunho = ("Gêmeos");
...
var mesNovembro = ("Escorpião");
var mesDezembro = ("Sagitário");
